 ...
 * Modifications by Chad Windnagle
 */
...
class JDocumentRendererModule extends JDocumentRenderer
{
	...
	public function render($module, $attribs = array(), $content = null)
	{
		...
		// append the path to the contents before sending out the module
		$contents.='<pre>'.$path.'</pre>';

		return $contents;
	}
	
	public function displayModPaths($modules)
	{
		$path = '';
		$name = $modules->module;
	...
	public static function isOverridden($name)
	{
		// get the app
		$app = JFactory::getApplication();
